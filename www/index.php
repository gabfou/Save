...
<?php
	...
	if (isset($_SESSION['project']) && isset($_SESSION['id_client']))
	{
		...
		$echofinal = $echofinal.'<div id = "intro"><p>Bonjour et merci de participer a cette étude</p><p>Veuillez clicker sur le bouton suivant et repondre aux questions.</p></div>';
		echo '<ul id="menupbar">';
