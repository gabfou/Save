...
public:
    ...
    {
        SendEmail->setWindowTitle(QApplication::translate("SendEmail", "Form", 0));
        label->setText(QApplication::translate("SendEmail", "SMTP server:", 0));
        label_2->setText(QApplication::translate("SendEmail", "Port:", 0));
        ssl->setText(QApplication::translate("SendEmail", "SSL", 0));
        label_4->setText(QApplication::translate("SendEmail", "Use authentication", 0));
        auth->setText(QString());
        label_5->setText(QApplication::translate("SendEmail", "Username:", 0));
        label_6->setText(QApplication::translate("SendEmail", "Password:", 0));
        label_7->setText(QApplication::translate("SendEmail", "Mime E-mail", 0));
        label_8->setText(QApplication::translate("SendEmail", "Sender:", 0));
        label_9->setText(QApplication::translate("SendEmail", "Recipients:", 0));
        label_10->setText(QApplication::translate("SendEmail", "Subject:", 0));
        label_3->setText(QApplication::translate("SendEmail", "Attachments:", 0));
        addAttachment->setText(QApplication::translate("SendEmail", "Add File", 0));
        sendEmail->setText(QApplication::translate("SendEmail", "Send Email", 0));
    } // retranslateUi
